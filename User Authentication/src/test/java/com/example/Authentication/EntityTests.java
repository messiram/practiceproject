...
public class EntityTests {
	...
	public void getAndSetName() {
		...
		testUser.setName("master");
		assertEquals(testUser.getName(),"master");
	}
	...
	public void getAndSetEmail() {
		...
		testUser.setEmail("master@email.com");
		assertEquals(testUser.getEmail(),"master@email.com");
	}
	...
	public void checkConstructor() {
		User testUser = new User("master","master@email.com","123");
		
		User checkUser = new User();
		checkUser.setName("master");
		checkUser.setEmail("master@email.com");
